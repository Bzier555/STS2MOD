...
One of several mod projects in the [`STS2MOD`](../README.md) repository, this is a collaborative Slay the Spire 2 content-mod prototype. It adds one shared colorless card, `Unstable Hex`, which applies two distinct random enemy debuffs.
